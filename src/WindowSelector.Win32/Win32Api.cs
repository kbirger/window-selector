...
namespace WindowSelector.Win32
{
    ...
    out IntPtr lpdwResult);
        ...
        [DllImport("User32.dll", SetLastError = true)]
        public static extern bool ShowWindow(IntPtr handle, WindowShowStyle nCmdShow);
        ...
        //public static extern bool EnumWindows(EnumWindowsProc lpEnumFunc, ref NativeWindowInfo data);

        //public delegate bool EnumWindowsProc(IntPtr hWnd, ref NativeWindowInfo data);
        ...
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Auto)]
        public static extern bool SendMessageCallback(IntPtr hWnd, uint Msg, int wParam,
            int lParam, SendMessageDelegate lpCallBack, UIntPtr dwData);
